...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">T.I</h1>
    </div>
        ...
        <div class="card text-center">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="#home" aria-selected="true" >Manutenção de Computadores</a>
                    </li>
                </ul>
            </div> 
            <div class="card-body"> 
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search float-left" method="POST" action="manutencao.php">
                            <div class="input-group">
                                <div class="input-group">
                        ...
                        <table class="table table-bordered table-responsive" width="100%">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th scope="col" width="">Computador</th>
                                    <th scope="col" width="" >Usuário</th>
                                    <th scope="col" width="" >Data</th>
                                    <th scope="col" width="" >Problema</th>
                                    <th scope="col" width="" >Manutenção</th>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                   <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editModal" 
                                                       ...
                                                       data-whatevercomputador="<?php echo $computador; ?>" 
                                                       data-whateverusuario="<?php echo $usuario; ?>"  
                                                       data-whateverdata="<?php echo $data; ?>"
                                                       data-whateverproblema="<?php echo $problema; ?>"
                                                       data-whatevermanutencao="<?php echo $manutencao; ?>"
                                                       data-whateverobs="<?php echo $obs;?>
                                                       " data-whateverstatus="<?php echo $status; ?>"
                                                       >Editar</button>
                                                </li>
                                                <li>
                                                    <form class="form-horizontal" method="POST" action="cadastrar_manutencao.php?id=<?php echo $id; ?> ">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              ...
                                              ID: <?php echo $id; ?>
                                              <br>
                                              Computador: <?php echo $computador; ?>
                                              <br>
                                              Usuário: <?php echo $usuario; ?>
                                              <br>
                                              Data: <?php echo $data; ?> 
                                              <br>
                                              Problema: <?php echo $problema; ?>
                                              <br>
                                              Manutenção: <?php echo $manutencao; ?>
                                              <br>
                                              Observações: <?php echo $obs; ?>
                                              <br>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  class="form-horizontal" method="POST" action="cadastrar_manutencao.php">
                    <div class="form-group">
                        <label for="recipientid" class="control-label">ID:</label>
                        <input type="text" name="id" class="form-control" id="recipientid">
                    </div>
                    <div class="form-group">
                        <label for="recipient-computador" class="control-label">Computador:</label>
                        <input type="text" name="computador" class="form-control" id="recipient-computador">
                    </div>
                    <div class="form-group">
                        <label for="recipient-usuario" class="control-label">Usuário:</label>
                        <input type="text" name="usuario" class="form-control" id="recipient-usuario" >
                    </div>
                    <div class="form-group">
                        <label for="recipient-data" class="control-label">Data:</label>
                        <input type="text" name="data" class="form-control" id="recipient-data">
                    </div>
                    <div class="form-group">
                        <label for="recipient-problema" class="control-label">Problema:</label>
                        <input type="text" name="problema" class="form-control" id="recipient-problema">
                    </div>
                    <div class="form-group">
                        <label for="recipient-manutencao" class="control-label">Manutenção:</label>
                        <input type="text" name="manutencao" class="form-control" id="recipient-manutencao">
                    </div>
                    <div class="form-group">
                        <label for="recipient-obs" class="control-label">Observações:</label>
                        <input type="text" name="obs" class="form-control" id="recipient-obs">
                    </div>
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="recipient-status">
                            ...
                            <option value="25">Em Análise</option>
                            <option value="50">Em Manutenção</option>
                            <option value="75">Teste</option>
...
<div class="modal fade" id="cadAlvaraModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-body">
        <form  class="form-horizontal" method="POST" action="cadastrar_manutencao.php" enctype="multipart/form-data">
            <div class="form-group">
                <label for="recipient-computador" class="control-label">Computador:</label>
                <input type="text" name="computador" class="form-control" id="recipient-computador">
            </div>
...
<script type="text/javascript">
  ...
  var button = $(event.relatedTarget) // Button that triggered the modal
   var recipient = button.data('whatevercomputador')// Extract info from data-* attributes
   var recipientid = button.data('whateverid')
   var recipientusuario = button.data('whateverusuario')
   var recipientdata = button.data('whateverdata')
   var recipientproblema = button.data('whateverproblema')
   ...
   modal.find('#recipient-computador').val(recipient)
   ...
   modal.find('#recipient-problema').val(recipientproblema)
   modal.find('#recipient-manutencao').val(recipientmanutencao)
   modal.find('#recipient-obs').val(recipientobs)
