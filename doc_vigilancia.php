...
<div class="container-fluid">
           ...
           <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="cadAnexo.php?vigilancia_id=<?php echo $vigilancia_id;?>&tipo=3" enctype="multipart/form-data">
                        <label>Nome:</label>
   ...
   <div class="card text-center">
    <div class="capa">Vigilância Sanitária</div>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 1 and vigilancia_id = '".$vigilancia_id."' ";
                ...
                <div class="tab-pane fade" id="cei" role="tabplanel" aria-labelledby="cei-tab">
                   <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 2 and vigilancia_id = '".$vigilancia_id."' ";
                    $result = mysqli_query($con, $sql);
                    echo mysqli_error($con);
                    if(mysqli_num_rows($result)==0){
                    }else{
                ...
                <div class="tab-pane fade" id="certidoes" role="tabplanel" aria-labelledby="certidoes-tab">
                   <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 3 and vigilancia_id = '".$vigilancia_id."' ";
                    $result = mysqli_query($con, $sql);
                    echo mysqli_error($con);
                    if(mysqli_num_rows($result)==0){
                    }else{
                ...
                <div class="tab-pane fade" id="cnpj" role="tabplanel" aria-labelledby="cnpj-tab">
                   <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 4 and vigilancia_id = '".$vigilancia_id."' ";
                    $result = mysqli_query($con, $sql);
                    echo mysqli_error($con);
                    if(mysqli_num_rows($result)==0){
                    }else{
                ...
                <div class="tab-pane fade" id="contrato" role="tabplanel" aria-labelledby="contrato-tab">
                   <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 5 and vigilancia_id = '".$vigilancia_id."' ";
                    $result = mysqli_query($con, $sql);
                    echo mysqli_error($con);
                    if(mysqli_num_rows($result)==0){
                    }else{
                ...
                <div class="tab-pane fade" id="doc_socio" role="tabplanel" aria-labelledby="doc_socio-tab">
                   <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 6 and vigilancia_id = '".$vigilancia_id."' ";
                    $result = mysqli_query($con, $sql);
                    echo mysqli_error($con);
                    if(mysqli_num_rows($result)==0){
                    }else{
                ...
                <div class="tab-pane fade" id="outros" role="tabplanel" aria-labelledby="outros-tab">
                   <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 7 and vigilancia_id = '".$vigilancia_id."' ";
                    $result = mysqli_query($con, $sql);
                    echo mysqli_error($con);
                    if(mysqli_num_rows($result)==0){
                    }else{
                ...
                <div class="tab-pane fade" id="acordo" role="tabplanel" aria-labelledby="acordo-tab">
                   <table class="table" width="100%">
                    ...
                    <?php 
                    $sql = "SELECT arquivo FROM anexo_vigilancia WHERE categoria = 8 and vigilancia_id = '".$vigilancia_id."' ";
                    $result = mysqli_query($con, $sql);
                    echo mysqli_error($con);
                    if(mysqli_num_rows($result)==0){
                    }else{
